                    ...
                    <form class="layui-form" action="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="tradeName" autocomplete="off" placeholder="交易请求对应的交易所名称" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">交易URL</label>
                            <div class="layui-input-block">
                                <input type="text" name="tradeUrl" autocomplete="off" placeholder="发起交易请求的URL" class="layui-input" >
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">数量URL</label>
                            <div class="layui-input-block">
                                <input type="text" name="totalNumUrl" autocomplete="off" placeholder="获取当前单价盘面数量URL" class="layui-input">
                            </div>
                        </div>
                        <%--  <div class="layui-form-item">
...
<script type="application/javascript">
    layui.use(['form', 'layer'], function(){
        ...
        form.on('submit(save)', function(obj){
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/system/thread/platform/insert',
                data: obj.field,
