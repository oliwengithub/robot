                ...
                <div class="layui-card-body" pad15>
                    <form class="layui-form" action="">
                                ...
                                <select name="groupId" lay-verify="required" lay-search="">
                                    ...
                                    <c:if test="${not empty quartzGroups}">
                                        <c:forEach items="${quartzGroups}" var="quartzGroup">
                                            <option value="${quartzGroup.id}" <c:if test="${quartzGroup.id == quartz.tradePlatformId}">selected</c:if> >${quartzGroup.name}</option>
                                        </c:forEach>
                                    </c:if>
                                </select>
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="name" autocomplete="off" placeholder="任务名称" class="layui-input" value="${quartz.name}">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">全限定类名</label>
                            <div class="layui-input-block">
                                <input type="number" name="className" value="${quartz.className}" placeholder="全限定类名" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">方法名称</label>
                            <div class="layui-input-block">
                                <input type="number" name="methodName" value="${quartz.methodName}" placeholder="methodName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">cron时间表达式</label>
                            <div class="layui-input-block">
                                <input type="number" name="cronExpression" value="${quartz.cronExpression}" placeholder="cron时间表达式" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">任务描述</label>
                            <div class="layui-input-block">
                                <input type="number" name="description" value="${quartz.description}" placeholder="任务描述" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-input-block">
