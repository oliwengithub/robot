layui.define('view', function(exports){
  ...
  var events = admin.events = {
    ...
    ,theme: function(){
      admin.popupRight({
        ...
        ,success: function(){
          view(this.id).render('pages/system/theme')
        }
      });
    }
    ...
    ,about: function(){
      admin.popupRight({
        ...
        ,success: function(){
          view(this.id).render('pages/system/about');
        }
      });
    }
    ...
    ,more: function(){
      admin.popupRight({
        ...
        ,success: function(){
          view(this.id).render('pages/system/more');
        }
      });
    }
  ...
  !function(){
    ...
    if(layui.data('lock').status === true){
        admin.events.lock();
    }
