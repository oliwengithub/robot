...
Source Database       : admin-demo

Target Server Type    : MYSQL
Target Server Version : 50720
File Encoding         : 65001

Date: 2020-03-25 21:04:16
*/
...
CREATE TABLE `system_auth` (
  ...
  `role_ids` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '角色名称',
  `admin_id` int(11) NOT NULL DEFAULT '0',
  `admin_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`auth_id`) USING BTREE,
  UNIQUE KEY `UNIQ_user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统权限表';
...
CREATE TABLE `system_config` (
  ...
  `code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '名称',
  `value` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '数值',
  `admin_id` int(11) NOT NULL DEFAULT '0',
  `admin_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uniq_f_code_name` (`name`),
  KEY `idx_code` (`code`)
...
CREATE TABLE `system_menu` (
  ...
  `name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '菜单名称',
  `url` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '菜单链接',
  `type` int(1) DEFAULT NULL COMMENT '菜单类型：0、菜单；1、按钮；2、操作',
  `tag` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '操作按钮的tag',
  ...
  KEY `IDX_name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统菜单表';
...
CREATE TABLE `system_operation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '操作名称',
  `url` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '请求链接',
  `params` longtext COLLATE utf8mb4_unicode_ci COMMENT '请求参数',
  `ip` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '登录IP地址',
  `user_agent` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '设备标示',
  `admin_id` int(11) NOT NULL DEFAULT '0' COMMENT '操作人',
  `admin_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '操作人',
  `create_time` datetime DEFAULT NULL COMMENT '操作时间',
  `create_idate` int(10) DEFAULT NULL COMMENT '操作日期',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=192 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统操作记录';
...
CREATE TABLE `system_role` (
  ...
  `menu_ids` varchar(4000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '权限ID列表',
...
CREATE TABLE `trade_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sdk_price_url` varchar(100) DEFAULT NULL COMMENT '参数url',
  `sdk_to_usdt_url` varchar(100) DEFAULT NULL COMMENT '将货币转换成usdt链接',
  `symbol` varchar(50) DEFAULT NULL COMMENT '交易对',
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COMMENT='交易配置表';

-- ----------------------------
-- Records of trade_config
-- ----------------------------
INSERT INTO `trade_config` VALUES ('1', 'https://www.okex.me/api/spot/v3/instruments/BTC-USDT/ticker', 'https://www.okex.me/api/spot/v3/instruments/BTC-USDT/ticker', 'btc_usdt', '2020-01-07 21:09:37');
INSERT INTO `trade_config` VALUES ('2', 'https://www.okex.me/api/spot/v3/instruments/LTC-USDT/ticker', 'https://www.okex.me/api/spot/v3/instruments/LTC-USDT/ticker', 'ltc_usdt', '2020-01-07 21:16:02');
INSERT INTO `trade_config` VALUES ('3', 'https://www.okex.me/api/spot/v3/instruments/ETH-USDT/ticker', 'https://www.okex.me/api/spot/v3/instruments/ETH-USDT/ticker', 'eth_usdt', '2020-01-08 14:23:54');
INSERT INTO `trade_config` VALUES ('4', 'https://www.okex.me/api/spot/v3/instruments/OKB-USDT/ticker', 'https://www.okex.me/api/spot/v3/instruments/OKB-USDT/ticker', 'okb_usdt', '2020-01-08 14:24:23');
INSERT INTO `trade_config` VALUES ('5', 'https://www.okex.me/api/spot/v3/instruments/ETC-USDT/ticker', 'https://www.okex.me/api/spot/v3/instruments/ETC-USDT/ticker', 'etc_usdt', '2020-01-08 14:28:35');
INSERT INTO `trade_config` VALUES ('6', 'https://www.okex.me/api/spot/v3/instruments/BCH-USDT/ticker', 'https://www.okex.me/api/spot/v3/instruments/BCH-USDT/ticker', 'bch_usdt', '2020-01-08 14:29:36');
INSERT INTO `trade_config` VALUES ('7', 'https://www.okex.me/api/spot/v3/instruments/EOS-USDT/ticker', 'https://www.okex.me/api/spot/v3/instruments/EOS-USDT/ticker', 'eos_usdt', '2020-01-08 14:30:12');
INSERT INTO `trade_config` VALUES ('8', 'https://www.okex.me/api/spot/v3/instruments/XRP-USDT/ticker', 'https://www.okex.me/api/spot/v3/instruments/XRP-USDT/ticker', 'xrp_usdt', '2020-01-08 14:30:49');
INSERT INTO `trade_config` VALUES ('9', 'https://www.okex.me/api/spot/v3/instruments/TRX-USDT/ticker', 'https://www.okex.me/api/spot/v3/instruments/TRX-USDT/ticker', 'trx_usdt', '2020-01-08 14:31:21');
INSERT INTO `trade_config` VALUES ('10', 'https://www.okex.me/api/spot/v3/instruments/ETH_BTC/ticker', 'https://www.okex.me/api/spot/v3/instruments/ETH-USDT/ticker', 'eth_btc', '2020-01-16 19:40:39');
INSERT INTO `trade_config` VALUES ('11', 'https://www.okex.me/api/spot/v3/instruments/EOS_BTC/ticker', 'https://www.okex.me/api/spot/v3/instruments/EOS-USDT/ticker', 'eos_btc', '2020-01-16 19:41:28');
INSERT INTO `trade_config` VALUES ('12', 'https://www.okex.me/api/spot/v3/instruments/LTC_BTC/ticker', 'https://www.okex.me/api/spot/v3/instruments/LTC-USDT/ticker', 'ltc_btc', '2020-01-16 19:42:08');
INSERT INTO `trade_config` VALUES ('13', 'https://www.okex.me/api/spot/v3/instruments/EOS_ETH/ticker', 'https://www.okex.me/api/spot/v3/instruments/EOS-USDT/ticker', 'eos_eth', '2020-01-16 19:42:47');
INSERT INTO `trade_config` VALUES ('14', 'https://www.okex.me/api/spot/v3/instruments/LTC_ETH/ticker', 'https://www.okex.me/api/spot/v3/instruments/LTC-USDT/ticker', 'ltc_eth', '2020-01-16 19:43:25');

-- ----------------------------
-- Table structure for trade_platform
-- ----------------------------
DROP TABLE IF EXISTS `trade_platform`;
CREATE TABLE `trade_platform` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `trade_url` varchar(100) DEFAULT NULL COMMENT '交易url',
  `trade_name` varchar(100) DEFAULT NULL COMMENT '交易类型(所属交易所名称)',
  `total_num_url` varchar(100) DEFAULT NULL COMMENT '获取当前单价盘面数量url',
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='交易所名称表';

-- ----------------------------
-- Records of trade_platform
-- ----------------------------
INSERT INTO `trade_platform` VALUES ('1', 'http://223.84.147.165:1655/agextrade/trade/fabu', 'IPFS', 'http://223.84.147.165:1655/agextrade/market/getPriceToNum', null);
INSERT INTO `trade_platform` VALUES ('2', 'http://192.168.50.21:8080/birdtrade/trade/fabu', 'TEST_BIRD', 'http://192.168.50.21:8080/birdtrade/market/getPriceToNum', null);
INSERT INTO `trade_platform` VALUES ('3', 'http://61.4.114.63/agextrade/trade/fabu', 'BIRD', 'http://61.4.114.63/agextrade/market/getPriceToNum', null);

-- ----------------------------
-- Table structure for trade_thread
-- ----------------------------
DROP TABLE IF EXISTS `trade_thread`;
CREATE TABLE `trade_thread` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `client_id` int(11) NOT NULL COMMENT '交易机器人id',
  `trade_max` double(20,15) DEFAULT NULL COMMENT '默认单笔挂单最大限额(人民币)',
  `trade_min` double(20,15) DEFAULT NULL COMMENT '默认单笔挂单最小限额(人民币)',
  `wave_ratio` double(10,8) DEFAULT '0.00010000' COMMENT '单价波动范围(在原始价格上波动一般为万分之一左右)',
  `price_digit` int(2) DEFAULT NULL COMMENT '单价小数位',
  `num_digit` int(2) DEFAULT NULL COMMENT '数量小数位',
  `task_cycle` int(11) DEFAULT NULL COMMENT '任务调度周期（单位毫秒 1s = 1000ms）',
  `status` int(2) DEFAULT '0' COMMENT '机器人状态：0.关闭，1.开启，2.删除',
  `trade_platform_id` int(11) DEFAULT NULL COMMENT '交易所主键id',
  `trade_config_id` int(11) DEFAULT NULL COMMENT '交易配置id',
  `start_time` datetime DEFAULT NULL COMMENT '开启时间',
  `stop_time` datetime DEFAULT NULL COMMENT '终止时间',
  `create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COMMENT='交易线程表';

-- ----------------------------
-- Records of trade_thread
-- ----------------------------
INSERT INTO `trade_thread` VALUES ('1', '50027', '50.000000000000000', '10.000000000000000', '0.00010000', '3', '6', '5000', '1', '1', '1', '2020-03-25 17:43:32', '2020-03-25 17:29:04', '2020-01-08 15:33:36');
INSERT INTO `trade_thread` VALUES ('2', '50030', '50.000000000000000', '10.000000000000000', '0.00010000', '3', '6', '5000', '1', '1', '2', '2020-03-25 17:43:32', '2020-03-25 17:29:04', '2020-01-08 15:33:41');
INSERT INTO `trade_thread` VALUES ('3', '50028', '50.000000000000000', '10.000000000000000', '0.00010000', '3', '5', '5000', '1', '1', '3', '2020-03-25 17:43:32', '2020-03-25 17:29:04', '2020-01-08 15:33:44');
INSERT INTO `trade_thread` VALUES ('4', '4', '0.000000000000000', '0.000000000000000', '0.00000000', '1', '1', '1000', '0', '1', '4', '2020-01-15 14:21:03', '2020-03-12 10:48:28', '2020-01-08 15:33:47');
INSERT INTO `trade_thread` VALUES ('5', '5', '0.000000000000000', '0.000000000000000', '0.00000000', '1', '1', '1000', '0', '1', '5', '2020-01-15 14:21:03', '2020-03-12 10:48:28', '2020-01-08 15:33:50');
INSERT INTO `trade_thread` VALUES ('6', '50031', '50.000000000000000', '10.000000000000000', '0.00010000', '3', '6', '5000', '1', '1', '6', '2020-03-25 17:43:32', '2020-03-25 17:29:04', '2020-01-08 15:33:53');
INSERT INTO `trade_thread` VALUES ('7', '50029', '50.000000000000000', '10.000000000000000', '0.00010000', '3', '4', '5000', '1', '1', '7', '2020-03-25 17:43:32', '2020-03-25 17:29:04', '2020-01-08 15:33:56');
INSERT INTO `trade_thread` VALUES ('8', '30029', '50.000000000000000', '10.000000000000000', '0.80000000', '3', '6', '1000', '0', '2', '1', '2020-01-15 14:24:22', '2020-03-12 10:48:28', null);
INSERT INTO `trade_thread` VALUES ('9', '30010', '50.000000000000000', '10.000000000000000', '0.01430000', '3', '5', '1000', '0', '2', '3', '2020-01-15 14:24:22', '2020-03-12 10:48:28', null);
INSERT INTO `trade_thread` VALUES ('10', '30028', '50.000000000000000', '10.000000000000000', '0.00510000', '3', '4', '1000', '0', '2', '2', '2020-01-15 14:24:22', '2020-03-12 10:48:28', null);
INSERT INTO `trade_thread` VALUES ('12', '10011', '50.000000000000000', '10.000000000000000', '0.00010000', '2', '6', '2000', '0', '3', '1', '2020-03-17 13:53:59', '2020-03-17 13:54:28', '2020-01-16 18:43:43');
INSERT INTO `trade_thread` VALUES ('13', '10075', '50.000000000000000', '10.000000000000000', '0.00010000', '3', '4', '2000', '0', '3', '3', '2020-03-17 13:53:18', '2020-03-17 13:53:30', '2020-01-16 18:45:36');
INSERT INTO `trade_thread` VALUES ('14', '10120', '50.000000000000000', '10.000000000000000', '0.00010000', '3', '5', '2000', '0', '3', '6', '2020-02-03 14:11:50', '2020-03-03 16:01:00', '2020-01-16 18:48:08');
INSERT INTO `trade_thread` VALUES ('15', '10121', '50.000000000000000', '10.000000000000000', '0.00010000', '3', '3', '2000', '0', '3', '7', '2020-02-03 14:11:50', '2020-03-03 16:01:00', '2020-01-16 18:49:29');
INSERT INTO `trade_thread` VALUES ('16', '10119', '50.000000000000000', '10.000000000000000', '0.00010000', '3', '4', '2000', '0', '3', '2', '2020-02-03 14:11:50', '2020-03-03 16:01:00', '2020-01-16 18:50:12');
INSERT INTO `trade_thread` VALUES ('17', '30036', '50.000000000000000', '10.000000000000000', '0.00010000', '6', '5', '2000', '0', '3', '10', '2020-02-03 14:11:50', '2020-03-03 16:01:00', '2020-01-16 19:45:42');
INSERT INTO `trade_thread` VALUES ('18', '30038', '50.000000000000000', '10.000000000000000', '0.00010000', '6', '5', '2000', '0', '3', '12', '2020-02-03 14:11:50', '2020-03-03 16:01:00', '2020-01-16 19:49:28');
INSERT INTO `trade_thread` VALUES ('19', '30037', '50.000000000000000', '10.000000000000000', '0.00010000', '8', '5', '2000', '0', '3', '11', '2020-02-03 14:11:50', '2020-03-03 16:01:00', '2020-01-16 19:51:14');
INSERT INTO `trade_thread` VALUES ('20', '30040', '50.000000000000000', '10.000000000000000', '0.00010000', '4', '4', '2000', '0', '3', '14', '2020-02-03 14:11:50', '2020-03-03 16:01:00', '2020-01-16 19:51:57');
INSERT INTO `trade_thread` VALUES ('21', '30039', '50.000000000000000', '10.000000000000000', '0.00010000', '8', '4', '2000', '0', '3', '13', '2020-02-03 14:11:50', '2020-03-03 16:01:00', '2020-01-16 19:52:51');
INSERT INTO `trade_thread` VALUES ('22', '50085', '50.000000000000000', '10.000000000000000', '0.00010000', '8', '4', '5000', '1', '1', '13', '2020-03-25 17:43:32', '2020-03-25 17:29:04', '2020-03-23 14:29:09');
INSERT INTO `trade_thread` VALUES ('23', '50086', '50.000000000000000', '10.000000000000000', '0.00010000', '4', '4', '5000', '1', '1', '14', '2020-03-25 17:43:32', '2020-03-25 17:29:04', '2020-03-23 14:30:18');
INSERT INTO `trade_thread` VALUES ('24', '50032', '50.000000000000000', '10.000000000000000', '0.00010000', '6', '5', '5000', '1', '1', '10', '2020-03-25 17:43:32', '2020-03-25 17:29:04', '2020-03-23 14:31:01');
INSERT INTO `trade_thread` VALUES ('25', '50083', '50.000000000000000', '10.000000000000000', '0.00010000', '8', '5', '5000', '1', '1', '11', '2020-03-25 17:43:32', '2020-03-25 17:29:04', '2020-03-23 14:31:28');
INSERT INTO `trade_thread` VALUES ('26', '50084', '50.000000000000000', '10.000000000000000', '0.00010000', '6', '5', '5000', '1', '1', '12', '2020-03-25 17:43:32', '2020-03-25 17:29:04', '2020-03-23 14:32:26');
